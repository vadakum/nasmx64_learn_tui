...
> This means we must be careful to use the 64-bit constant values defined in `termbox2.h`. For example, to make text blink, we will use `0x10000000` and not `0x1000`
```
#if TB_OPT_ATTR_W == 16
